    ...
    <App>
      ...
      <Container maxWidth="md">
        ...
        <Typography variant="body1" paragraph>
          At <span className="website_name">NMBO</span>, we collect and manage user data according to the following Privacy Policy.
        </Typography>
        ...
        <Typography variant="body1" paragraph>
          We only use your personal information to provide you the <span className="website_name">NMBO</span> services or to communicate with you about the Website or the services.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <ul>
          <li><Typography variant="body1">Doing so is appropriate to carry out your own request</Typography></li>
          <li><Typography variant="body1">We believe it's needed to enforce our legal agreements or that is legally required</Typography></li>
          <li><Typography variant="body1">We believe it's needed to detect, prevent or address fraud, security or technical issues</Typography></li>
        </ul>
