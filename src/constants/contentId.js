...
export const ACCOUNT_BUTTON_NOTIF_SIGN_UP_BUTTON = 'account_button_notif_sign_up_button';
export const ACCOUNT_BUTTON_NOTIF_SIGN_IN_BUTTON = 'account_button_notif_sign_in_button'; 
...
export const FOOTER_FEEDBACK_BUTTON = 'footer_feedback_button'; 
export const FOOTER_PRIVACY_BUTTON = 'footer_privacy_button'; 
export const FOOTER_ABOUT_BUTTON = 'footer_about_button'; 
export const SIGN_UP_PAGE_SUBMIT_BUTTON = 'sign_up_page_submit_button';
export const SIGN_UP_PAGE_SIGN_IN_BUTTON = 'sign_up_page_sign_in_button';
export const SIGN_IN_PAGE_SUBMIT_BUTTON = 'sign_in_page_submit_button'; 
...
export const SIGN_IN_WITH_FACEBOOK_BUTTON = 'sign_in_with_facebook_button'; 
export const SIGN_UP_WITH_FACEBOOK_BUTTON = 'sign_up_with_facebook_button'; 
